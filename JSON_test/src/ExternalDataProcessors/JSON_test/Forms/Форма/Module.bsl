...
Процедура СформироватьСтруктуруНаСервере()
	...
	СтрокаЗначение = СтруктураВСтрокуJSON(СтрукЗначение);
	
	Сообщить("Преобразовано: Структура в Строка");
	
	НовСтрукЗначение = СтрокаJSONВСтруктуру(СтрокаЗначение);

	Сообщить("Преобразовано: Строка в Структура");
